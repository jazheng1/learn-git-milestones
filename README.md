...
1b | Link to `commit #1 from Github.com` | [commit #1 from Github.com](https://github.com/omundy/learn-git-milestones/commit/c018ea66d883f77082d4d174838627f90184a6b1)
...
2f | Link to `commit #4 from Atom` | [commit #4 from Github.com](https://github.com/jazheng1/learn-git-milestones/commit/2553105d285f79b65bdb95b477d37dc9dad84fc8)
3a | Link to `my-awesome-project` github.com repo page | [repo](https://github.com/jazheng1/my-awesome-project)
4a | Link to `my-awesome-project` github.io "project site" | [website](https://jazheng1.github.io/my-awesome-project/)
... | ... | Total: 0/12
